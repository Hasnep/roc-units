...
footPoundForceToJoules = \x -> (Num.toF64 x) / (poundForceToNewtons 1) * (feetToMeters 1)
expect
    out = footPoundForceToJoules 1000000.000f64
    out |> Num.isApproxEq 1355817.948f64 {}
...
joulesToFootPoundForce = \x -> x * (poundForceToNewtons 1) * (feetToMeters 1)
expect
    out = joulesToFootPoundForce 1355817.948f64
    out |> Num.isApproxEq 1000000.000f64 {}
