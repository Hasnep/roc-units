...
## Parse a number as a mass in tonnes.
tonnes : F64 -> Mass F64
tonnes = \x -> kilograms (Convert.tonnesToKilograms x)

## Convert a mass to a number of tonnes.
...
## Parse a number as a length in light years.
